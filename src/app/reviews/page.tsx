  ...
  return (
    <main className="max-w-4xl mx-auto p-6 bg-black min-h-screen text-white">
      ...
      <p className="text-neutral-400 mb-8 pl-5">
        Resenhas pós-corrida, análises táticas e tudo sobre o rendimento das equipes.
      </p>

      <div className="grid gap-6">
        {posts && posts.length > 0 ? (
          posts.map((post) => (
            /* AGORA É UM LINK QUE LEVA PARA /reviews/nome-do-artigo */
            <Link 
          ...
          <p className="text-neutral-500 italic">Nenhuma análise publicada até o momento.</p>
        )}
      </div>
    </main>
  );
